...
Now-common ideas like â€œearly adoptersâ€? and â€œviral marketingâ€? grew from sociological studies of the diffusion of innovations. One of the most famous of these studies tracked how a then-new antibiotic, tetracycline, spread among doctors in four small cities in Illionis in the 1950s. In this lab, we will go back to that data to look at one of the crucial ideas, that of the innovation (prescribing tetracycline) â€œspreadingâ€? from person to person.
...
```{r}
not_NA = which(!is.na(ckm_nodes$adoption_date))
ckm_nodes = ckm_nodes[not_NA,]
```
...
```{r}
plot(table(ckm_nodes$adoption_date))
...
7. Counting Peer Pressure
    ...
    b. What proportion of doctor 37 friends do those two doctors represent? 